...
ALTER TABLE customer ADD CONSTRAINT FK_CUSTOMER_ON_USER FOREIGN KEY (user_id) REFERENCES user_ (id);

ALTER TABLE department ADD CONSTRAINT FK_DEPARTMENT_ON_MANAGER FOREIGN KEY (manager_id) REFERENCES user_ (id);
...
ALTER TABLE user_credentials ADD CONSTRAINT FK_USER_CREDENTIALS_ON_USER FOREIGN KEY (user_id) REFERENCES user_ (id);

ALTER TABLE user_role ADD CONSTRAINT FK_USER_ROLE_ON_USER FOREIGN KEY (user_id) REFERENCES user_ (id);

ALTER TABLE user_ ADD CONSTRAINT FK_USER__ON_DEPARTMENT FOREIGN KEY (department_id) REFERENCES department (id);